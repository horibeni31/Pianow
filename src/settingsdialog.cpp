...
SettingsDialog::SettingsDialog(QWidget *parent)
    : QDialog(parent), _ui(new Ui::SettingsDialog()) {
  _ui->setupUi(this);
...
SettingsDialog::~SettingsDialog() { delete _ui; }

void SettingsDialog::accept() {
  Settings::getInstance()->setMidiDevice(
      _ui->comboBox->itemText(_ui->comboBox->currentIndex()).toStdString());
